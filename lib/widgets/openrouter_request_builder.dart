...
class OpenRouterRequestBuilder extends StatefulWidget {
  ...
  @override
  State<OpenRouterRequestBuilder> createState() => _OpenRouterRequestBuilderState();
}

class _OpenRouterRequestBuilderState extends State<OpenRouterRequestBuilder> with TickerProviderStateMixin {
  final OpenRouterService _service = OpenRouterService();
  final TextEditingController _apiKeyController = TextEditingController();
  final TextEditingController _systemMessageController = TextEditingController();
  ...
  OpenRouterRequest _buildRequest() {
    ...
    if (_systemMessageController.text.isNotEmpty) {
      messages.add(ChatMessage(role: 'system', content: _systemMessageController.text));
    }
    
    if (_userMessageController.text.isNotEmpty) {
      messages.add(ChatMessage(role: 'user', content: _userMessageController.text));
    }
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_models.isNotEmpty)
                    ...
                    const Text('No models available. Please check your API key.'),
                ],
              ),
            ),
          ),
